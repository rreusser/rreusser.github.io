...
`;function u(e,t){return e.createShaderModule({code:t,label:"Normal map shader"})}function f(e,t={}){const r=t.tileSize||512,a=t.tileBuffer||1,o=u(e,l),i=e.createBindGroupLayout({label:"Normal map bind group layout",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}}]}),n=e.createPipelineLayout({label:"Normal map pipeline layout",bindGroupLayouts:[i]});return{pipeline:e.createComputePipeline({label:"Normal map compute pipeline",layout:n,compute:{module:o,entryPoint:"main",constants:{tileSize:r,tileBuffer:a}}}),bindGroupLayout:i}}export{f as createNormalMapPipeline};
