...
var explanation = h('div.explanation', [
  h('h1', [
    ...
    h('br'),
    'random coefficients on the integer complex grid and leading term 1',
    h('br'),
    h('small', [
      'Poked around at haphazardly and then explained wonderfully and further inspired by John Baez\'s ',
