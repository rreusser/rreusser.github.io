...
function interactionEvents (opts, callback) {
  ...
  function forward(evOut, evIn) {
    evOut.defaultPrevented = false;
    evOut.preventDefault = function () {
      evOut.defaultPrevented = true;
    };
    evOut.captured = captured;
    evOut.capture = function () {
      captured = true;
    };
    evOut.originalEvent = evIn;
    return evOut;
  }
  ...
  function queue (event) {
    ...
    lastEvent.defaultPrevented = false;
  ...
  function onTouchStart (event) {
    ...
    if (activeCount > 0) {
      ...
      ev.buttons = 0;
      ev.mods = {};
      ev.x0 = newTouch.clientX;
      ev.y0 = newTouch.clientY;
      ev.dx = 0;
      ev.dy = 0;
      ev.dz = 0;
      ev.dsx = 1;
