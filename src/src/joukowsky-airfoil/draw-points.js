...
module.exports = function (regl) {
  return regl({
    vert: `
      ...
      uniform float pixelRatio, pointSize, z, aspect, zblend, zrange, globalScale, scalePoints, fadeOutStart, fadeInEnd, countFactor;
      ...
      void main () {
        float param = 1.0 - uv.z * countFactor;
        ...
        color = texture2D(colorscale, vec2(param, 0.5));
