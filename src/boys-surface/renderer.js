export function createRenderer(device, canvasFormat, shaderCodes) {
  ...
  const peelModule = device.createShaderModule({ label: 'boys-peel-shader', code: shaderCodes.peel });
  const compositeModule = device.createShaderModule({ label: 'boys-composite-shader', code: shaderCodes.composite });
