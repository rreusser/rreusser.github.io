...
2. **Kerr shadow**: the shadow acquires a D-shaped asymmetry — the side rotating
   toward the observer is slightly trimmed; the retrograde side bulges
3. **Disk asymmetry**: with the camera above the equatorial plane and the disk
...
4. **Einstein ring**: looking nearly through the black hole produces a thin ring;
