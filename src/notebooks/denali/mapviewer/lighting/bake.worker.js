...
//
// Lifted from line-sweep-terrain-lighting/cpu-bake-worker.js, with
// WorkerPool's id-based message protocol so it plugs into the existing
// pool infrastructure. Computes (nx, ny, ao, shadow) packed RGBA8 for
// the tile-level compositing in shaders/terrain.js.
//
// Two job types:
...
function computeLSAO(heights, N, pxSizeByRow, horizon, HN, lsaoFalloff, parentScale, horizonPN) {
...
function computeShadow(heights, N, pxSizeByRow, horizon, HN, azDeg, altDeg, sunRadiusDeg, samples, parentScale, compHMin, horizonHMax, horizonPN) {
